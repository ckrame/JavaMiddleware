...
public class SimpleHTML implements HTMLDocument {
	...
	public void addHeading(String text) {
		if (text == null) return;
		SimpleStringBuilder paragraph = Toolkit.getInstance().createSimpleStringBuilder();
	...
	private void openTag(SimpleStringBuilder buf, String name) {
		buf.append(BEGINTAG);
		buf.append(name);
		buf.append(ENDTAG);
	}

	private void closeTag(SimpleStringBuilder buf, String name) {
		buf.append(BEGINTAG);
		buf.append(SEP);
		buf.append(name);
		buf.append(ENDTAG);
