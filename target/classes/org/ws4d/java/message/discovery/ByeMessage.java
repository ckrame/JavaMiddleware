...
public class ByeMessage extends MessageWithDiscoveryData {
	...
	/**
	 * Creates a new Bye message with {@link DiscoveryData} and create a new
	...
	/**
	 * Creates a new Bye message containing a {@link SOAPHeader} and {@link DiscoveryData}. All header fields are empty and it is the caller's
