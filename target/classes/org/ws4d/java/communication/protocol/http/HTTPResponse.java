...
public abstract class HTTPResponse {
	...
	public abstract void serializeResponseBody(URI request, HTTPRequestHeader header, OutputStream out, ConnectionInfo connectionInfo, MonitoringContext context) throws IOException;
	 ...
	 * method must block until the corresponding {@link HTTPRequestHandler} which generated this {@link HTTPResponse} instance is done with request
	 * processing.
	 */
	public void waitFor() {
	...
	public String getUniqueIdForAttachmentCleanup() {
		return (readerToWaitFor == null) ? null : readerToWaitFor.getUniqueId();
	}
}
