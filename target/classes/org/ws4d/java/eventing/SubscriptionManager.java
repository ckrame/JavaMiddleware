...
public interface SubscriptionManager {
	 ...
	 *             fault message with further details can be obtained from this <code>SOAPException</code> (see {@link SOAPException#getFault()})
	 */
	 ...
	 *             message with further details can be obtained from this <code>SOAPException</code> (see {@link SOAPException#getFault()})
	 */
	 ...
	 */
	public long renew(ClientSubscription subscription, long duration) throws EventingException, CommunicationException;
