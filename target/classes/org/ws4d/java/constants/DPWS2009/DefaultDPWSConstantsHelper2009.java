...
public class DefaultDPWSConstantsHelper2009 extends DPWSConstantsHelper {
	...
	static {
		...
		WSA_2009_PROBLEM_ACTION_SCHEMA_ELEMENT = new Element(WSAConstants.WSA_PROBLEM_ACTION, detailType);
	}
	...
	public int getRandomApplicationDelay() {
		return DPWSConstants2009.DPWS_APP_MAX_DELAY;
	}

	public int getUnicastUDPRepeat() {
		return DPWSConstants2009.MULTICAST_UDP_REPEAT;
	}

	public int getMulticastUDPRepeat() {
		return DPWSConstants2009.UNICAST_UDP_REPEAT;
	}
	...
	public String getDPWSNamespacePrefix() {
		return DPWSConstants2009.DPWS_NAMESPACE_PREFIX;
	}
	...
	public String getMetadataDialectThisModel() {
		return DPWSConstants2009.DPWS_NAMESPACE_NAME + DPWSConstants.METADATA_DIALECT_THISMODEL;
	}

	public String getMetadataDialectThisDevice() {
		return DPWSConstants2009.DPWS_NAMESPACE_NAME + DPWSConstants.METADATA_DIALECT_THISDEVICE;
	}

	public String getMetatdataDialectRelationship() {
		return DPWSConstants2009.DPWS_NAMESPACE_NAME + DPWSConstants.METADATA_DIALECT_RELATIONSHIP;
	}

	public String getMetadataRelationshipHostingType() {
		return DPWSConstants2009.DPWS_NAMESPACE_NAME + DPWSConstants.METADATA_RELATIONSHIP_HOSTING_TYPE;
	}
