...
public final class Log {
	 ...
	 * 
	 * @param set <code>true</code> if Debug should show time stamps, <code>false</code> if not.
	 */
	 ...
	 * 
	 * @param logStackTrace <code>true</code> if Debug should log stack traces, <code>false</code> if not.
	 */
	...
	/**
	 * Checks whether the current log level is at least {@link #DEBUG_LEVEL_DEBUG}.
	 * 
	 * @return whether the current log level is at least {@link #DEBUG_LEVEL_DEBUG} or not
	 */
	...
	/**
	 * Checks whether the current log level is at least {@link #DEBUG_LEVEL_INFO}.
	 * 
	 * @return whether the current log level is at least {@link #DEBUG_LEVEL_INFO} or not
	 */
	...
	/**
	 * Checks whether the current log level is at least {@link #DEBUG_LEVEL_WARN}.
	 * 
	 * @return whether the current log level is at least {@link #DEBUG_LEVEL_WARN} or not
	 */
	...
	/**
	 * Checks whether the current log level is at least {@link #DEBUG_LEVEL_ERROR}.
	 * 
	 * @return whether the current log level is at least {@link #DEBUG_LEVEL_ERROR} or not
	 */
	 ...
	 */
	private static void notifySubscribers(int level, String message) {
		for (Enumeration subEnum = subscribers.elements(); subEnum.hasMoreElements();) {
			((LogSubscriber) subEnum.nextElement()).notify(level, message);
		}
	}
	...
	public static void setNormalOutput(PrintStream newout) {
		out = newout;
	}

	public static void setErrorOutput(PrintStream newout) {
		err = newout;
	}
}
