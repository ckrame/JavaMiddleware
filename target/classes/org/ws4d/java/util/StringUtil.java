...
public final class StringUtil {
	...
	public static String[] splitAtWhitespace(String s) {
		...
		for (i = 0; i < len; i++) {
			 ...
			 * arbitrary sequences of one of the characters #x9 (tab), #xA (line
			 * feed), #xD (carriage return) or #x20 (space)
			 */
				case ('\t'):
				case ('\n'):
				case ('\r'):
	...
	public static String vectorToString(Vector v, String separator) {
		...
		for (Enumeration enu = v.elements(); enu.hasMoreElements();) {
			s.append(enu.nextElement().toString());
			s.append(separator);
		}
		return s.toTrimmedString();
	}
		...
		if (str != null) {
			...
			while (i < str.length()) {
				...
				// "Reserved characters"
					...
					case 0x2B:// Plus ("+")
					case 0x2C:// Comma (",")
					case 0x2F:// Forward slash/Virgule ("/")
					case 0x3A:// Colon (":")
	...
	public static String decodeURL(String url, String encoding) throws UnsupportedEncodingException {
		...
		SimpleStringBuilder mainBuffer = Toolkit.getInstance().createSimpleStringBuilder(length);
	 ...
	 * @return either the fully qualified or the simple class name of argument <code>clazz</code>
	 ...
	 * (&quote;.&quote;), within the name of <code>clazz</code>, i.e. <code>Object</code> instead of <code>java.lang.Object</code>.
	 * 
	 ...
	 * returns only the substring after the last dot character
	 * (&quote;.&quote;), i.e. <code>Object</code> instead of <code>java.lang.Object</code>.
	 * 
	 * @param qualifiedClassName a fully qualified Java class name
	 * @return the simple class name
	 */
