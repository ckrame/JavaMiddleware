...
public class URI {
	 ...
	 * <p>
	 * This method allows to change the path of the URI. For instance: <a href="http://example.org/testing">http://example.org/testing</a> into <a href="http://example.org/stable">http://example.org/stable</a>
	 * </p>
	 * 
	...
	/**
	 * Creates an URI from a base URI as <code>String</code> and a path as <code>String</code> which is regarded to be relative to the given base
	 * URI.
	 * 
	...
	private void removeDotsFromPath() {
		...
		SimpleStringBuilder result = Toolkit.getInstance().createSimpleStringBuilder(inputBuffer.length());
	...
	public String toString() {
		SimpleStringBuilder buffer = Toolkit.getInstance().createSimpleStringBuilder(20);
		if (schema != null) {
	...
	public int getOctetLength() {
		...
		if (schema != null) {
			result += schema.length() + 1;
		}
		if (authority != null) {
			result += authority.length() + 2;
		}
		if (path != null) {
			result += path.length();
		}
	 ...
	 * 
	 * @param other
	 * @return <code>true</code> only if this URI instance equals <code>other</code> in terms of RFC3986 equality
	 */
	public boolean equalsWsdRfc3986(final URI other) {
		...
		} else if (!getSchemaDecoded().equals(other.getSchemaDecoded())) {
			return false;
		}
	...
	/**
	 * Returns <code>true</code> if this is a relative URI, <code>false</code> if the base part is set.
	 * 
	 * @return <code>true</code> if this is a relative URI, <code>false</code> if the base part is set.
	 */
	 ...
	 * 
	 * @return <code>true</code>, if the URI could be parsed, <code>false</code> otherwise.
	 */
	...
	/**
	 * Returns <code>true</code> if this URI has the URN schema, <code>false</code> otherwise.
	 * 
	 * @return <code>true</code> if this URI has the URN schema, <code>false</code> otherwise.
	 */
	...
	public String getPathDecoded() {
		...
		return (pathDecoded != null) ? pathDecoded : String.valueOf(GD_SLASH);
	}

	/**
	 * Returns the path defined in the URI in its encoded form. If no path is
	 * set, "/" is returned.
	 * 
	 * @return the encoded path.
	 */
	public String getPath() {
		return (path != null) ? path : String.valueOf(GD_SLASH);
	}
	...
	public void setQuery(String query) {
		...
		this.query = StringUtil.encodeStringForURL(query);
		this.hash = 0;
	}
	...
	public void setFragment(String fragment) {
		...
		this.fragment = StringUtil.encodeStringForURL(fragment);
		this.hash = 0;
	}
	...
	/**
	 * Creates a new URI from newUri and baseUri if newURI is a relative path,
	 * otherwise just newUri is the new URI.
	 * 
	 * @param baseUri
	 * @param newUri
	 * @return an absolute URI created from <code>baseUri</code> and <code>newUri</code>
	 */
	 ...
	 *            checked.
	 * @return <code>true</code> if the string is a IPv6 address, <code>false</code> otherwise.
	 */
