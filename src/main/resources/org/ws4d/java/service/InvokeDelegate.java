...
public interface InvokeDelegate {
	...
	/**
	 * Executes the business logic associated with the given <code>operation</code>. The values of any available input parameters can
	 * be obtained from the supplied <code>arguments</code>. The returned value
	 * corresponds to the result of the operation. In case any {@link Operation#getFaults() predefined faults} arise during the
