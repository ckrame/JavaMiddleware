 ...
 * <h3>Framework</h3>
 * <p>
 * If you like to create the element described above, it is necessary to create the derived data type too and use the primitive data type <i>string</i>. If you can access predefined primitive data types with the {@link SchemaUtil#getSchemaType(QName)} method.<br />
 ...
 * <ul>
 * <li><a href="http://www.w3.org/TR/xmlschema11-1/#ref.elt.global">http://www.w3 .org/TR/xmlschema11-1/#ref.elt.global</a></li>
 * <li>XML Schema:
 * <p>
 ...
 * <ul>
 * <li><a href="http://www.w3.org/TR/xmlschema11-1/#sec-cos-equiv-class">http://www .w3.org/TR/xmlschema11-1/#sec-cos-equiv-class</a></li>
 * <li>XML Schema:
 * <p>
 * 
 * <pre>
	...
	static final Element createElement(ElementParser parser, String targetNamespace, Schema schema, boolean globalScope) throws XmlPullParserException, IOException, SchemaException {
		...
		if (eType != null && eRef == null) {
			...
			if (XMLSCHEMA_NAMESPACE.equals(ns)) {
				Type t = SchemaUtil.getSchemaType(typeName);
				if (t != null) {
					e.setType(t);
				}
			} else {
	...
	void serialize(XmlSerializer serializer, Schema schema) throws IOException {
		...
		if (type != null) {
			...
			if (typeName == null) {
				...
				serializeAttributes(serializer);
				// Added by SSch - Bugfix
				schema.addBaseReference(type);
			}
