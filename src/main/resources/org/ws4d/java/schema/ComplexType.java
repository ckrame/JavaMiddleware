 ...
 * <p>
 * Those types are part of the XML Schema definition and are used inside WSDL documents to describe the content of a message. It is possible to define XML Schema structures with the classes {@link Schema}, {@link Element}, {@link Attribute}, {@link SimpleType}, {@link ComplexType}, {@link Group} and {@link AttributeGroup}. This is at least necessary to invoke SOAP operations (like used in DPWS).<br />
 ...
 * <h4>Model groups</h4>
 * <ul>
 * <li><a href="http://www.w3.org/TR/xmlschema11-1/#Model_Groups">http://www.w3.org /TR/xmlschema11-1/#Model_Groups</a></li>
 * <li>XML Schema:
 * <p>
 * Different model groups allow the assignment of an order to the content structure. The content order can be <strong>all</strong>, <strong>sequence</strong> or <strong>choice</strong>. The <strong>all</strong> model group does not restrict the order of the content. The <strong>sequence</strong> model group requires the correct order of the content. The <strong>choice</strong> model group allows only one element to be chosen for content.
 * 
 * <pre>
 * &lt;xs:schema xmlns:xs=&quot;http://www.w3.org/2001/XMLSchema&quot; targetNamespace=&quot;http://www.example.org&quot;&gt;
 ...
 * <li>XML:
 * <p>
 * The XML Schema listed above allows three different elements to be used as root element for an XML instance. In case of the element "all", the inner elements do not need any order. The order can be: a, b or b, a.<br />
 * 
 * <pre>
 * &lt;?xml version=&quot;1.0&quot;?&gt;
 * &lt;all&gt;
 ...
 * </pre>
 * 
 * In case of the element "sequence", the inner elements can only be used in the given order. The order can be: a, b<br />
 * 
 * <pre>
 * &lt;?xml version=&quot;1.0&quot;?&gt;
 * &lt;sequence&gt;
 ...
 * </pre>
 * 
 * In case of the element "choice", one element must be chosen from the given elements. The elements can be: a or b, not both. <br />
 * 
 * <pre>
 * &lt;?xml version=&quot;1.0&quot;?&gt;
 * &lt;choice&gt;
 ...
 * <li>Framework:
 * <p>
 * The framework supports the <strong>all</strong>, <strong>sequence</strong> and <strong>choice</strong> model groups.
 * 
 * <pre>
 * // get primitive data types
 * Type xsString = SchemaUtil.getSchemaType(&quot;string&quot;);
...
public class ComplexType extends Type {
	...
	/**
	 * This constructor <strong>must</strong> be used when declaring <em>top-level</em> types, which have a non-empty name.
	 * 
	...
	/**
	 * This constructor <strong>must</strong> be used when declaring <em>inline</em> types, which <strong>must not</strong> have a name.
	 * 
	 * @param containerType the type of the enclosed container.
	 * @see #CONTAINER_ALL
	 * @see #CONTAINER_SEQUENCE
