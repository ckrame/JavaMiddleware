...
public interface Attributable {
	...
	/**
	 * Returns the value of the attribute with the given <code>name</code> or <code>null</code>, if this attribute is not available (or if its value is
	...
	/**
	 * Sets the <code>value</code> for the attribute with the specified <code>name</code>. Throws a <code>java.lang.IllegalArgumentException</code> in case <code>name</code> is <code>null</code>.
	 * 
	 * @param name the name of the attribute to set, must not be <code>null</code>
	 * @param value the value to set the named attribute to (may be <code>null</code>
	 * @throws IllegalArgumentException if <code>name</code> is <code>null</code>
	 */
	public void setAttribute(QName name, CustomAttributeValue value);

	/**
	 * Sets the <code>value</code> for the attribute with the specified <code>name</code>. The value will be represented as plain String. It will
	 * be wrapped within a new instance of {@link StringAttributeValue}. This
	 * method throws a <code>java.lang.IllegalArgumentException</code> in case <code>name</code> is <code>null</code>.
	 * <p>
	 * This is a shorthand for <code>setAttribute(name, new StringAttributeValue(value))</code>.
	 * </p>
	 * 
	 * @param name the name of the attribute to set, must not be <code>null</code>
	 * @param value the value to set the named attribute to (may be <code>null</code>
	...
	/**
	 * Returns all attributes explicitly set for this {@link Attributable} instance. Note that depending on the actual implementation the returned
	...
	/**
	 * Sets all attributes at once to those contained within argument <code>attributes</code>. Note that depending on the actual implementation
	 ...
	 * map should be made with care. This method throws a <code>java.lang.IllegalArgumentException</code> in cases where <code>attributes</code> is <code>null</code>.
	 * 
