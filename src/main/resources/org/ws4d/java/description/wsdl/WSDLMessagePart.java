...
public class WSDLMessagePart {
	 ...
	 * namespace of the surrounding message if one exists, or <code>null</code> otherwise.
	 * 
	 * @return the namespace of the surrounding message of this part, or <code>null</code> if message not set
	 */
