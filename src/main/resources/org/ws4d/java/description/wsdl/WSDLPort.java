...
public abstract class WSDLPort {
	 ...
	 * namespace of the surrounding service if one exists, or <code>null</code> otherwise.
	 * 
	 * @return the namespace of the service of this port, or <code>null</code> if service not set
	 */
