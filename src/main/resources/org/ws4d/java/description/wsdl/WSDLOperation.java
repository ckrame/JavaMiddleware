...
public class WSDLOperation extends AttributableSupport {
	...
	/**
	 * @return the name of this WSDL operation's input, if any, or <code>null</code>
	 */
	...
	/**
	 * @return the name of this WSDL operation's output, if any, or <code>null</code>
	 */
	 ...
	 * namespace of the surrounding port type if one exists, or <code>null</code> otherwise.
	 * 
	 * @return the namespace of the port type of this operation, or <code>null</code> if port type not set
	 */
