 ...
 * </p>
 * <p>
 * If it is not possible to determinate the content type of the resource, the {@link #getContentType()} method should return at least the application/octet-stream content type.
 * </p>
 */
public interface Resource {
	 ...
	 * </p>
	 * <p>
	 * <strong>NOTICE:</strong> The map must contain a <code>String</code>, <code>String</code> mapping.
	 * </p>
	 * 
	 ...
	 * <p>
	 * If it is not possible to determinate the size of the resource. The implementation should return <code>-1</code>. This will allow to send the resource as chunked content.
	 * </p>
	 * 
