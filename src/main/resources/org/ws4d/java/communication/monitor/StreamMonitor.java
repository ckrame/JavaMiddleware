...
public interface StreamMonitor {
	 ...
	 * <p>
	 * Remember: This method should always return the same <code>OutputStream</code> for an individual <code>StreamMonitor</code> because it is used in different parts of the framework.
	 * </p>
	 * 
	 ...
	 * with the <code>getOutputStream</code> method. The assigned message is
	 * contained in the monitoring context.
	 * 
	 * @param context the context which should be assigned to the <code>OutputStream</code>
	 ...
	 * build a correct message object. It is like the <code>assign</code> method, but points to a fault while the message is created.
	 */
