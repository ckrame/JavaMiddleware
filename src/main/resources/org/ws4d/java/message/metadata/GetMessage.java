...
public class GetMessage extends Message {
	...
	/**
	 * Creates a new Get message containing a new created {@link SOAPHeader}.
	 * All header- and transfer-related fields are empty and it is the caller's
	...
	/**
	 * Creates a new Get message with the given {@link SOAPHeader}.
	 * 
	 * @param header
	 */
