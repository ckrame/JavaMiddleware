...
public abstract class DataStructure {
	 ...
	 * @return <code>true</code> if the object was actually added, <code>false</code> in any other case (e.g. adding an object to a
	 *         set which already contains the same object in terms of <code>java.lang.Object.equals(Object)</code>)
	 */
	 ...
	 * @return <code>true</code> if at least one object from <code>data</code> was actually added, i.e. a modification was made to this
	 *         instance, <code>false</code> in any other case (e.g. adding
	 *         objects to a set which already contains them in terms of <code>java.lang.Object.equals(Object)</code>)
	 */
	...
	/**
	 * Checks whether <code>obj</code> (or another instance equal to <code>obj</code> in terms of <code>java.lang.Object.equals(Object)</code> ) is already present within this data structure instance and returns <code>true</code> only if this is the case.
	 * 
	...
	/**
	 * Returns the short name of the class of this <code>DataStructure</code> instance.
	 * 
	 ...
	 * 
	 * @return <code>true</code> if this data structure is empty, <code>false</code> otherwise
	 */
	...
	/**
	 * Removes <code>obj</code> from this data structure. Returns <code>true</code> if <code>obj</code> was actually present and thus it
	 ...
	 * structure an array of length zero is returned (rather than <code>null</code>).
	 * 
	 ...
	 * <p>
	 * The array is expected not to be <code>null</code> and to be of exactly {@link #size()} length. Otherwise, either a <code>java.lang.NullPointerException</code> or an <code>java.lang.IllegalArgumentException</code> will be thrown.
	 * </p>
	 * 
	...
	public String toString() {
		...
		SimpleStringBuilder sb = Toolkit.getInstance().createSimpleStringBuilder(16 * size);
		sb.append("{");
