 ...
 * Constants of DPWS.
 */
public interface DPWSConstants2009 {
	...
	public static final int				DPWS_VERSION_INT							= 1;

	/** Constant to display the Name of the DPWS Version */
	public static final String			DPWS_VERSION_NAME							= "DPWS1.1";
	...
	public static final DeviceTypeQName	DPWS_QN_DEVICETYPE							= new DeviceTypeQName(DPWSConstants.DPWS_TYPE_DEVICE, DPWS_NAMESPACE_NAME, DPWS_NAMESPACE_PREFIX, QName.QNAME_WITH_PRIORITY, DPWSProtocolVersion.DPWS_VERSION_2009);
