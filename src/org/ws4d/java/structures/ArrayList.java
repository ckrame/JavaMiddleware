...
public class ArrayList extends List {
	...
	public void add(Object[] src, int srcPos, int destPos, int len) {
		changes++;
		checkCapacity(destPos + len);
		System.arraycopy(src, srcPos, elements, destPos, len);
		size = size + len;
	}
	...
	public void arrayCopy(int srcPos, Object[] dest, int destPos, int len) {
		System.arraycopy(elements, srcPos, dest, destPos, len);
	}
}
