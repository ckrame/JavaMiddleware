...
public interface WSDLBindingBuilder {
	 ...
	 * @return soapAction of Binding Operation
	 ...
	 */
	public String parseOperationExtension(String operationName, ElementParser parser) throws UnsupportedBindingException;
	...
	/**
	 * Parses an extension section within a WSDL port definition and returns a {@link WSDLPort} instance representing the port together with its
	 * extension.
	 * 
