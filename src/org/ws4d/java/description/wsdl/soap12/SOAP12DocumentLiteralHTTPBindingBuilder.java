...
import org.ws4d.java.description.wsdl.WSDLBindingBuilder;
import org.ws4d.java.description.wsdl.WSDLPort;
...
public class SOAP12DocumentLiteralHTTPBindingBuilder implements WSDLBindingBuilder {
	...
	protected void setBinding(SOAP12DocumentLiteralHTTPBinding binding) {
	...
	public void parseBindingExtension(QName bindingName, QName portType, ElementParser parser) throws UnsupportedBindingException {
		...
		setBinding(new SOAP12DocumentLiteralHTTPBinding(bindingName, portType));
	}
