...
public interface DatagramSocket {
	 ...
	 * the receiver. The method sends length bytes starting at the current <code>offset</code> of the Datagram object, where length and <code>offset</code> are internal state variables of the Datagram object.
	 * 
