...
public interface HTTPRequest {
	 ...
	 * @param connectionInfo addressing information associated to the request
	 * @throws IOException
	 */
	 ...
	 * <p>
	 * The {@link HTTPClient} will call this method for a incoming response. If no {@link HTTPResponseHandler} belongs to this request, the HTTP client will check the internal handler list.
	 * </p>
	 * 
	 ...
	 * @throws IOException
	 */
	public HTTPResponseHandler getResponseHandler(ContentType mediaType) throws IOException;
