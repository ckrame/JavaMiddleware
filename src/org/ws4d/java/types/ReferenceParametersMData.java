...
public class ReferenceParametersMData extends UnknownDataContainer {
	...
	public boolean isEmpty(boolean useReferenceParameterMode) {
		if ((wseIdentifier == null || !useReferenceParameterMode) && (parameters == null || parameters.isEmpty()) && (unknownElements_QN_2_List == null || unknownElements_QN_2_List.isEmpty()) && (unknownAttributes == null || unknownAttributes.isEmpty())) {
			return true;
		}
		return false;
	}
