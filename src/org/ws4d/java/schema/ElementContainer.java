 ...
 * <p>
 * <a href="http://www.w3.org/TR/xmlschema11-1/#Model_Groups">http://www.w3.org/ TR/xmlschema11-1/#Model_Groups<a>
 * </p>
 * <p>
...
public abstract class ElementContainer implements Any {
	...
	public Element getElementByName(String name) {
		...
		for (Iterator it = container.iterator(); it.hasNext();) {
			...
			if (e != null && name.equals(e.getName().getLocalPart())) {
				return e;
			}
		}
		return null;
	...
	/**
	 * Returns <code>true</code> if the container has element definitions, <code>false</code> otherwise.
	 * 
	 * @return <code>true</code> if the container has element definitions, <code>false</code> otherwise.
	 */
