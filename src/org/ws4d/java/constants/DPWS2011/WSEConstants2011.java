...
public interface WSEConstants2011 {
	...
	/* some constants were not changed, use WSEConstants.* to import them */
	...
	/* delivery formats */
	public static final String	WSE_DELIVERY_FORMAT_WRAP						= WSE_NAMESPACE_NAME + "/DeliveryFormats/Wrap";

	public static final String	WSE_DELIVERY_FORMAT_UNWRAP						= WSE_NAMESPACE_NAME + "/DeliveryFormats/Unwrap";
