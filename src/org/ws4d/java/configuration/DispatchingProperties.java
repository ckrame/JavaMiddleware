...
public class DispatchingProperties implements PropertiesHandler {
	...
	public void finishedSection(int depth) {
		// if (depth == 2) {
		// // DeviceProperties initialized
		// }
	}

	/**
	 * Gets target reference caching time, i. e. the time a {@link DeviceReference} is cached in the {@link DeviceServiceRegistry} without having a registered {@link DeviceListener}.
	 * 
	...
	/**
	 * Sets target reference caching time, i. e. the time a {@link DeviceReference} is cached in the {@link DeviceServiceRegistry} without having a registered {@link DeviceListener}.
	 * 
	 * @param targetReferenceCachingTime Time in millis a {@link DeviceReference} is cached without having a registered {@link DeviceListener}. Afterwards the reference is removed
	 ...
	 *            should be created for each recognized remote device, else <code>false</code>.
	 */
