...
public class DeviceProperties {
	 ...
	 */
	/**
	 * Property identifier of the configuration id, used while constructing a {@link DefaultDevice#DefaultDevice(int)}
	 */
	...
	/**
	 * Property identifier of the device port types. Value is a list of {@link QName}s
	 */
	public static final String				PROP_TYPES					= "Types";

	/**
	 * Property identifier of the list of device scopes. Value is a list of {@link URI}
	 */
	...
	private ArrayList						bindings					= new ArrayList(2);

	private ArrayList						discoveryBindings			= new ArrayList(2);
	...
	void addProperty(Property property) {
		 ...
		 */
			...
			CommunicationBinding bds = bindProps.getDiscoveryBinding(Integer.valueOf(property.value));
			if (bds != null) {
