...
public class RenewResponseMessage extends EventingResponseMessage {
	...
	/**
	 * Creates a new RenewResponse message containing a new created {@link SOAPHeader}. All header- and eventing-related fields are empty and
	...
	/**
	 * Creates a new RenewResponse message containing a {@link SOAPHeader}. All
