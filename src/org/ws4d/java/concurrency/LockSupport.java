...
public class LockSupport implements Lockable {
	...
	// if (trace != null) {
	// String t = "[thread=" + Thread.currentThread() + ", trace=" + trace[2] +
	// ", lock=" + lock + "]";
	...
	public synchronized String toString() {
		SimpleStringBuilder sb = Toolkit.getInstance().createSimpleStringBuilder(100);
	...
	private class Lock {
		...
		public String toString() {
			SimpleStringBuilder sb = Toolkit.getInstance().createSimpleStringBuilder(100);
			sb.append("Lock [ n=").append(Long.toString(lockNumber));
		 ...
		 * 
		 * @return <code>true</code> if the lock can be allocated, <code>false</code> otherwise.
		 */
